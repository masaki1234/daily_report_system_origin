...
public class Follow {
    ...
    @Column(name = "followd_at", nullable = false)
    private Timestamp followd_at ;
    ...
    public Timestamp getFollowd_at() {
        return followd_at;
    }

    public void setFollowd_at(Timestamp followd_at) {
        this.followd_at = followd_at;
    }
}